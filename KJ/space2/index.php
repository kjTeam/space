				...
				<ul class="navbar-nav nav " style="width:100%">
					...
					<?php
						...
						for($i=0;$i<$num_results;$i++)
						{
							...
							if(isset($row['link'])) echo "<li style='white-space:nowrap;width:10%;text-align:center'><a style='font-weight:bold' href='".$row['link']."'>".$row['func1_name']."</a></li>";
							else echo "<li style='white-space:nowrap;width:10%;text-align:center' ><a style='font-weight:bold' href='index.php?nav1=".$row['id_n1']."'>".$row['func1_name']."</a></li>"; //此处用#是不行的
						}
					?>
				</ul>
			</div>
