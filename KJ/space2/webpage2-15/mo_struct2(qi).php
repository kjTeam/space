...
$db=create_database();
$query="select * from mo2 where id_p=$id ";
...
if($num_results)	
{
	...
	switch ($row['state'])
	{
			...
			case 7:	echo "未通过审核，请联系管理员";exit();break;//通过审核
			default: echo "出错";exit();break;
	}
}
if($_POST["p33"]=='mo2') //检测是否是此表单提交
{
...
<form enctype='multipart/form-data' action='' method='post'>
    <h3 class='text-center'>中国钢结构协会空间结构分会膜结构工程专项设计企业等级会员复审申请表</h3>
	<br/>
        <table class='table table-bordered text-center table-responsive'>
            ...
            <tr>
                ...
                <td colspan='2'>电   话</td>
                <td colspan='4'><input type='phone' class='form-control' name='p7'> </td>
            </tr>
            <tr>
                <td colspan='2' >法定代表人</td>
                <td colspan='2'><input type='text' class='form-control' name='p8' ></td>
                <td colspan='2'>职务</td> <td colspan='2'><input type='text' class='form-control' name='p9'></td>
                <td colspan='2'>职称</td> <td colspan='2'><input type='text' class='form-control' name='p10'></td>
            </tr>
               <tr>
                   <td colspan='2' >企业负责人</td>
                   <td colspan='2'><input type='text' class='form-control' name='p11'></td>
                   <td colspan='2'>职务</td> <td colspan='2'><input type='text' class='form-control' name='p12'></td>
                   <td colspan='2'>职称</td> <td colspan='2'><input type='text' class='form-control' name='p13'></td>
               </tr>
               <tr>
                   <td colspan='2' >技术负责人</td>
                   <td colspan='2'><input type='text' class='form-control' name='p14'></td>
                   <td colspan='2'>职务</td> <td colspan='2'>
				   <input type='text' class='form-control' name='p15'></td>
                   <td colspan='2'>职称</td> <td colspan='2'><input type='text' class='form-control' name='p16'></td>
               </tr>
            <tr>
            <td colspan='2'>复审申请级别</td>
                <td colspan='4'><input type='text' class='form-control' name='p17'></td>
                <td colspan='2'>现有证书到期时间</td>
                <td colspan='4'><input type='text' class='form-control' name='p18'></td>
            </tr>
            <tr >
            ...
            <tr>
                <td colspan='3'>总工程师主持的膜结构<br>代表工程</td>
                <td colspan='6'>
            ...
            <tr >
                ...
                <td colspan='3'>近三年完成的膜结构展开面积及其总和</td>
                <td colspan='6'>
            ...
            <tr>
                ...
                <td colspan='6'><input type='text' class='form-control' rows='2' name='p27'></td>
            </tr>
            <tr>
                <td colspan='1'>5</td>
            ...
            <tr>
                ...
                <td colspan='9'><textarea type='text' class='form-control'rows='2' name='p29'></textarea></td>
            </tr>

        <tr>
            <td colspan='2' >填表日期</td>
            <td colspan='2'><input type='text' placeholder='格式：X年X月X日' class='form-control' name='p30'></td>
            <td colspan='2'>联系人</td> <td colspan='2'><input type='text' class='form-control' name='p31'></td>
            <td colspan='2'>手机</td> <td colspan='2'><input type='phone' class='form-control' name='p32'></td>
        </tr>
            </tbody>
        </table>
		<input type='hidden' value='mo2' name='p33'> ";
		if($flag==1) echo "<input type='hidden' value='yes' name='flag'> "; 

echo "
  <div style='float: right'> <button type='submit' class='btn btn-md btn-primary'>
      &nbsp;&nbsp; 提交 &nbsp; &nbsp;</button>
    <br> <br>
  </div>
</form>
...
<form class='form-horizontal' enctype='multipart/form-data' action='' method='post'>
 <h5 class='text-center'><strong>中国钢结构协会空间结构分会膜结构工程专项设计企业等级会员复审申请表</strong></h5>
