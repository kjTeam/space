<?php
//设立一个control表，入会申请、膜评审、膜复审、网评审、网复审、膜经理培训的category分别是1、2、3、4、5、6、7。state分为1和2，2是开通，1不开通。输入秘书处、管理员应该回复的时间，时间保存用户的时间戳。之前数据库里就存了记录，所以用update。如果直接开通没有输入的话，就出来弹出窗提示，确定提交。（这个还要学）
