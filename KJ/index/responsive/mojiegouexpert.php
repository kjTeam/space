...
<head>
    ...
    function initTable(unit,properties){
      ...
      $('#member').bootstrapTable({
          url: 'include/includedPHP/fourth_moexpert.php?type=1&unit='+unit1+'&properties='+properties1+'',
  ...
  <div class="form-group">
       ...
       <div class="col-sm-7">
          <input type="text" class="form-control" id="edit_zhuanjia_position">
       </div>
  </div>
</form>`,
         width:500,
      ...
      if(data){
        $.ajax({
            url: "include/includedPHP/fourth_moexpert.php?type=3 & name='"+name+"'&position='"+position+"'&company='"+company+"'&zhuanjia_position='"+zhuanjia_position+"'",
            type: "get",
            cache: false,
            contentType: false,
            processData: false,
  ...
  <div class="form-group">
      ...
      var zhuanjia_position = $('#edit_zhuanjia_position').val();
      $.ajax({
            url: "include/includedPHP/fourth_moexpert.php?type=2&id='"+select[0]['id']+"'&name='"+name+"'&position='"+position+"'&company='"+company+"'&zhuanjia_position='"+zhuanjia_position+"'",
            type: "get",
            cache: false,
            contentType: false,
            processData: false,
    ...
    function del(){
      ...
      if(select.length !=1){
        ...
        swal({
           ...
           if(data){
            $.ajax({
            url: "include/includedPHP/fourth_moexpert.php?type=4&id='"+select[0]['id']+"'",
            type: "get",
            cache: false,
            contentType: false,
            processData: false,
        ...
        <div class="col-md-10 right-col">
            <div class="right">
                <div class="right-title">
                    <p><strong>中国钢结构协会空间结构分会 第四届膜结构专业组名单</strong></p>
                </div>
                <hr/>
