...
if(!less_than_ie9()) {
    ...
    echo "<script language=javascript>location.href='responsive/announcement_content.php?id=$id&&pagename=$page_name';</script>";
    exit();
}
?>
    ...
    <div class="left-modify">
        <table>
            <tr>
                ...
                <tr>
                <td>
                    <a href="delete.php?pagename=$page_name&&id=$id">删除</a>
                </td>
            </tr>
        </table>
    </div>
EOD;
    ...
    <?php include 'include/page_right_content.php' ?>
</div>
